...
export const addFriend= createAsyncThunk('friend/addFriend',async (data,{fulfillWithValue,rejectWithValue})=>{
  // console.log(data);
         try{
           const friendAdded= await axios.post(`${process.env.REACT_APP_BASE_URL}/api/friends/addfriend`,{
...
export const getAllFriendRequest= createAsyncThunk('friend/getAllFriendRequest',async (data,{fulfillWithValue,rejectWithValue})=>{
  // console.log(data);
         try{
           const friendRequest= await axios.get(`${process.env.REACT_APP_BASE_URL}/api/friends/getAllFriendRequest`,{
...
export const acceptFriend=createAsyncThunk('friend/acceptFriend',async(data,{fulfillWithValue,rejectWithValue})=>{
  // console.log(data);
   try {
     const response= await axios.post(`${process.env.REACT_APP_BASE_URL}/api/friends/acceptfriend`,{id:data.id},{
...
export const removeFriend=createAsyncThunk('friend/removeFriend',async(data,{fulfillWithValue,rejectWithValue})=>{
  // console.log(data);
   try {
     const response= await axios.post(`${process.env.REACT_APP_BASE_URL}/api/friends/removefriend`,{id:data.id},{
...
export const friendList=createAsyncThunk('friend/friendList',async(data,{fulfillWithValue,rejectWithValue})=>{
  // console.log(data);
   try {
     const response= await axios.post(`${process.env.REACT_APP_BASE_URL}/api/friends/friendlist`,{id:data.id},{
